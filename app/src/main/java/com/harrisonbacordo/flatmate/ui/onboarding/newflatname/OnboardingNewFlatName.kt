...
fun OnboardingNewFlatName(userId: String, onFlatSuccessfullyCreated: (userId: String) -> Unit, onBackClicked: () -> Unit) {
    val viewModel: OnboardingNewFlatNameViewModel = ViewModelProvider(LocalContext.current as ViewModelStoreOwner).get(OnboardingNewFlatNameViewModel::class.java)

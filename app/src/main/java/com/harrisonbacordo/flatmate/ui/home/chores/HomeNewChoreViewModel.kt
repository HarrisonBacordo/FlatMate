 ...
 */
class HomeNewChoreViewModel @ViewModelInject constructor(private val choreRepository: ChoreRepository, @Assisted private val savedStateHandle: SavedStateHandle) : ViewModel() {
}

data class HomeNewChoreState(
    val choreName: RequiredTextFieldState,
    val choreInterval: Interval = Interval.NotSelected,
    val assignedFlatmate: String,
